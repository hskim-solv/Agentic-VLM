...
- **Embedding 모델 ablation 1차 측정 + 2차 러너 확장** — 1차 측정(MiniLM-L12-v2 vs multilingual-e5-base, 2026-05-11): full agentic 파이프라인에서는 0pp Δ, naive_baseline에서는 e5-base가 accuracy +18.8pp — metadata-first filtering이 임베딩 선택에 robust함을 실증. 2차 사이클(#161): BGE-M3 / multilingual-e5-large-instruct / KURE-v1 / OpenAI text-embedding-3-large를 [`scripts/run_embedding_ablation.py`](scripts/run_embedding_ablation.py)로 측정 가능(OpenAI는 `BIDMATE_OPENAI_API_KEY` 옵트인). 디폴트는 그대로 MiniLM-L12-v2 — 향후 PR에서 디폴트 교체 시 ADR. 측정 결과는 [`docs/embedding-ablation.md`](docs/embedding-ablation.md).
...
| System | Latency (p50/p95) | p50 1.9ms / p95 7.3ms |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| naive_baseline | naive_baseline | 4 | off | off | off | 0.844±0.12 | 0.714±0.14 | 0.512±0.12 | 0.974±0.05 | 0.667 | 0.300 | 0.000 | 7.3ms |
| full | agentic_full | auto | on | on | on | 0.906±0.12 | 0.929±0.07 | 0.905±0.08 | 1.000±0.00 | 0.905 | 1.000 | 0.310 | 4.5ms |
| full_llm | agentic_full_llm | auto | on | on | on | 0.906±0.12 | 0.929±0.07 | 0.905±0.08 | 1.000±0.00 | 0.905 | 1.000 | 0.310 | 4.7ms |
| hierarchical | agentic_full | auto | on | on | on | 0.906±0.12 | 0.929±0.07 | 0.905±0.08 | 1.000±0.00 | 0.905 | 1.000 | 0.310 | 4.7ms |
| no_metadata_first | agentic_full | auto | off | on | on | 0.844±0.12 | 0.881±0.10 | 0.679±0.11 | 0.968±0.06 | 0.857 | 1.000 | 0.000 | 3.9ms |
...
| hybrid_bm25 | agentic_full | auto | on | on | on | 0.906±0.12 | 0.929±0.07 | 0.905±0.08 | 1.000±0.00 | 0.905 | 1.000 | 0.310 | 4.6ms |
