...
- **Embedding 모델 ablation 미실행** — `paraphrase-multilingual-MiniLM-L12-v2`(2019)을 채택했으나 2025년 최신 multilingual 모델(BGE-M3, multilingual-e5-large, KURE) 대비 품질 ablation은 다음 사이클 항목.
