...
- **성과**: 공개 synthetic 평가셋 **n=40** (single_doc 14 / comparison 10 / follow_up 9 / abstention 7) 기준 단일 추출/다문서 비교/후속질문/부재판별의 근거 기반 응답 품질을 검증했습니다. 통계적 유의성 한계와 다음 실험 우선순위는 아래 [성능표 캐비뱃](#핵심-성능표-실측)에 정직하게 명시했습니다.
...
| Evidence | Citation Precision | 0.500 |
| Evidence | Claim Citation Alignment | 0.974 |
| Evidence | Answer Format Compliance | 0.650 |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| naive_baseline | naive_baseline | 4 | off | off | off | 0.844 | 0.700 | 0.500 | 0.974 | 0.650 | 0.125 | 0.000 | 2.2ms |
| full | agentic_full | auto | on | on | on | 0.875 | 0.900 | 0.887 | 0.969 | 0.900 | 1.000 | 0.325 | 2.3ms |
| hierarchical | agentic_full | auto | on | on | on | 0.875 | 0.900 | 0.887 | 0.969 | 0.900 | 1.000 | 0.325 | 2.3ms |
| no_metadata_first | agentic_full | auto | off | on | on | 0.812 | 0.850 | 0.662 | 0.935 | 0.850 | 1.000 | 0.000 | 2.3ms |
| no_rerank | agentic_full | auto | on | off | on | 0.875 | 0.900 | 0.887 | 0.969 | 0.900 | 1.000 | 0.325 | 2.3ms |
| no_verifier_retry | agentic_full | auto | on | on | off | 0.906 | 0.750 | 0.750 | 1.000 | 0.700 | 0.125 | 0.000 | 2.1ms |
<!-- METRICS_TABLE:END -->
...
> **데이터 범위**: 성능표는 공개 synthetic RFP 평가셋(n=40) 기준이며, hashing 백엔드 측정값입니다. 원본 RFP 데이터는 비공개 제약으로 저장소에 포함하지 않았습니다.
> **통계적 유의성 한계**: n=40은 ablation 차이의 통계적 유의성 검증에 충분치 않습니다. 평가셋 확대(n≥100)와 bootstrap CI 보고가 다음 실험 사이클의 최우선 항목입니다.
